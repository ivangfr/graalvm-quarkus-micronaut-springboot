...
- ### springboot-elasticsearch
  ...
  [`Spring Boot`](https://docs.spring.io/spring-boot/index.html) Java Web application that exposes a simple REST API for indexing and searching movies in `Elasticsearch`. [Spring Initializr](https://start.spring.io/#!type=maven-project&language=java&platformVersion=4.0.5&packaging=jar&configurationFileFormat=properties&jvmVersion=17&groupId=com.ivanfranchin&artifactId=springboot-elasticsearch&packageName=com.ivanfranchin.springboot-elasticsearch&dependencies=web,actuator,validation,native,data-elasticsearch)
