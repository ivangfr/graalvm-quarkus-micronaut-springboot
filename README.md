...
------------------------------- + -------------- + -------------- + ----------------- + ----------------- |
    ...
    micronaut-simple-api-native |             5s |            15M |              174s |            77.5MB |
