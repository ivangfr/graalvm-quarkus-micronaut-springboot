...
- When building **Docker in Native Mode**, there is this [Issue #4585](https://github.com/micronaut-projects/micronaut-core/issues/4585): Error while building Docker native image
  ```
  [INFO] Fatal error:
